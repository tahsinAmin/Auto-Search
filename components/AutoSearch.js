      ...
      >
        ...
        >
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-1'>
            <div className='going-from  p-1 border-gray-100 border-b-2 outline-none'>
              <input
                type='text'
                name='input-search'
                className='w-full mt-4 placeholder-gray-600 '
            ...
            <div className='p-1 outline-none flex space-x-1'>
              <div className='w-[175px]'>Departing date:</div>
              <DatePicker
                selected={startDate}
                onChange={(date) => setStartDate(date)}
                className='border-gray-600 border-b-2 text-black'
              />
            </div>
          </div>
          <div>
