      ...
      <div>
        ...
        {weatherFound && (
          ...
          "
            ...
            "
              >
                <div class="icon-text flex flex-col items-center">
                  <div class="icon">
                    <svg
                      class="w-6 h-6"
                      fill="none"
                  ...
                  <div class="text-2xl font-semibold">Morning</div>
                </div>
                <div class="temp text-[100px] font-light">{todoArr[0]}°</div>
              </div>
              <div
                class="
              rounded-lg
            ...
            "
              >
                <div class="icon-text flex flex-col items-center">
                  ...
                  <div class="text-2xl font-semibold">Afternoon</div>
                </div>
                <div class="temp text-[100px] font-light">{todoArr[1]}°</div>
              </div>
              <div
                class="
              rounded-lg
            ...
            "
              >
                <div class="icon-text flex flex-col items-center">
                  ...
                  <div class="text-2xl font-semibold">Evening</div>
                </div>
                <div class="temp text-[100px] font-light">{todoArr[2]}°</div>
              </div>
              <div
                class="
              rounded-lg
            ...
            "
              >
                <div class="icon-text flex flex-col items-center">
                  ...
                  <div class="text-2xl font-semibold">Overnight</div>
                </div>
                <div class="temp text-[100px] font-light">{todoArr[3]}°</div>
              </div>
            </div>
          </section>
        )}
