          ...
          <div className="all-flights w-8/12 flex flex-col space-y-4 mt-4 border-gray-200 text-lg">
            ...
            <div className="sort-flights flex space-x-6">
              ...
              ease-out"
                  >
                    <svg
                      className="down-price price-toggle w-7 h-7 text-gray-800 font-semibold"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <svg
                      className="up-price hidden price-toggle w-7 h-7 text-gray-800 font-semibold"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex flex-col space-y-5">
                  ...
                  <div className="flight-item-info pl-5 flex justify-between items-center">
                    ...
                    <div className="mx-4 flex flex-col text-center">
                      <div className="text-sm">16 hrs 25 mins</div>
                      <img
                        className="max-w-full nav-row-logo"
                        loading="lazy"
                        src="/img/plane.png"
                        ...
                        height="26"
                      />
                      <div className="text-sm">2 stops</div>
                    </div>
                    <div className="flex flex-col items-center text-center">
